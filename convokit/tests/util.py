...
def fox_buffalo_doc():
    return Doc(
        ...
        words=[
            ...
            'dog', '.', 'Buffalo', 'buffalo', 'Buffalo', 'buffalo', 'buffalo',
            'buffalo', 'Buffalo', 'buffalo'
        ],
        heads=[4, 4, 4, 4, 4, 4, 8, 8, 5, 4, 11, 11, 13, 14, 15, 15, 17, 17],
        deps=[
            'det', 'amod', 'amod', 'compound', 'ROOT', 'prep', 'det', 'amod',
            'pobj', 'punct', 'compound', 'ROOT', 'compound', 'compound',
            'nsubj', 'ROOT', 'compound', 'ROOT'
        ],
        tags=[
            'DT', 'JJ', 'JJ', 'NN', 'NNS', 'IN', 'DT', 'JJ', 'NN', '.', 'NNP',
            'NNP', 'NNP', 'NNP', 'NNP', 'NNP', 'NNP', 'NNP'
        ])


def burr_sir_corpus(storage_type='mem'):
    ...
    return Corpus(utterances=utterances, storage_type=storage_type)
...
def parsed_burr_sir_corpus():
    ...
    sentence_lists = [[BURR_SIR_SENTENCE_1, BURR_SIR_SENTENCE_2],
