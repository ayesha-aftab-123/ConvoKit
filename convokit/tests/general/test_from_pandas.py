...
class CorpusFromPandas(unittest.TestCase):
    ...
    def test_reconstruction_stats(self):
        ...
        """
        self.assertEqual(set(self.new_corpus.iter_utterances()), set(self.corpus.iter_utterances()))
        self.assertEqual(set(self.new_corpus.iter_speakers()), set(self.corpus.iter_speakers()))
        self.assertEqual(
            set(self.new_corpus.iter_conversations()),
