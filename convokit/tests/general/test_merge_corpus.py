...
from convokit.storage import defaultCorpusStorageManager
...
class CorpusMerge(unittest.TestCase):
    def test_no_overlap(self):
        ...
        """
        defaultCorpusStorageManager.purge_all_collections()
    ...
    def test_add_utterance(self):
        ...
        u2 = corpus1.get_utterance('2')
        self.assertEqual(u2.meta, {'hey': 'jude', 'hello': 'world'})
        ...
        print('META: ', u2.meta)
        self.assertEqual(u2.meta, {'hey': 'jude', 'hello': 'world'})
        print('\tadding utterances to corpus')
        added = corpus1.add_utterances(utts)

        self.assertEqual(len(list(added.iter_utterances())), 4)
        print(f'\ttest (utt 2): {added.get_utterance("2")}')
        print(f'\ttest (utt 2.meta): {added.get_utterance("2").meta}')
