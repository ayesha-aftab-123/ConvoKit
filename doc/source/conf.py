...
# -*- coding: utf-8 -*-
#
# convokit documentation build configuration file, created by
...
# of the sidebar.
#
html_logo = 'img/convokit_logo.png'
...
latex_documents = [
    (master_doc, 'convokit.tex', 'convokit Documentation',
...
man_pages = [
    (master_doc, 'convokit', 'convokit Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'convokit', 'convokit Documentation',
     author, 'convokit', 'One line description of project.',
     'Miscellaneous'),
]
