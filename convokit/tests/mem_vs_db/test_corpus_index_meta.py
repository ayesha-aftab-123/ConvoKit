...
class CorpusIndexMeta(unittest.TestCase):
    ...
    def test_init_with_meta(self):
        ...
        self.assertEqual(corpus1_mem.get_utterance("0"), corpus1_db.get_utterance("0"))
        self.assertEqual(corpus1_mem.get_utterance("0").meta, corpus1_db.get_utterance("0").meta)
        self.assertEqual(corpus1_mem.get_utterance("1"), corpus1_db.get_utterance("1"))
        self.assertEqual(corpus1_mem.get_utterance("1").meta, corpus1_db.get_utterance("1").meta)
        self.assertEqual(corpus1_mem.get_utterance("2"), corpus1_db.get_utterance("2"))
        self.assertEqual(corpus1_mem.get_utterance("2").meta, corpus1_db.get_utterance("2").meta)

        self.assertEqual(corpus1_mem.get_conversation(None), corpus1_db.get_conversation(None))
        self.assertEqual(
            corpus1_mem.get_conversation(None).meta,
            corpus1_db.get_conversation(None).meta,
        )
        self.assertEqual(corpus1_mem.get_speaker("alice"), corpus1_db.get_speaker("alice"))
        self.assertEqual(
            corpus1_mem.get_speaker("alice").meta, corpus1_db.get_speaker("alice").meta
        )
        self.assertEqual(corpus1_mem.get_speaker("charlie"), corpus1_db.get_speaker("charlie"))
        self.assertEqual(
