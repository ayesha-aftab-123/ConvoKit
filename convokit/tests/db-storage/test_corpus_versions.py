...
def get_version_test_corpus():
    ...
    return Corpus(
        ...
        utterances=[
            ...
            Utterance(id="3", reply_to="2", conversation_id="0", speaker=bill, text="Bye!"),
        ],
    )
...
class DBStorage(unittest.TestCase):
    def test_connect_by_name_in_place(self):
        ...
        version_test_corpus1 = Corpus(
            corpus_id="version_test_corpus", storage_type="db", in_place=True
        )

        self.assertEqual(version_test_corpus0.storage, version_test_corpus1.storage)
        ...
        self.assertTrue(version_test_corpus0.get_utterance("4").meta["testing"])
        ...
        self.assertTrue(version_test_corpus1.get_utterance("4").meta["testing"])
    ...
    def test_connect_by_name_not_in_place(self):
        ...
        print(92)
        version_test_corpus1 = Corpus(
            corpus_id="version_test_corpus", storage_type="db", in_place=False
        )
        print(93)
        self.assertNotEqual(version_test_corpus0.storage, version_test_corpus1.storage)
